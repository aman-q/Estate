...
const ForgetPasswordVerify: React.FC<AccountVerificationProps> = ({ email, type }) => {
    ...
    const validateOtp = (): boolean => {
        ...
        if (otpValue.length < 6 || !otpValue.match(/^[0-9]{6}$/)) {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const response = await fetch(endpoint, {
                ...
                body: JSON.stringify({ userEmail: email, otp: otpCode }),
            });
